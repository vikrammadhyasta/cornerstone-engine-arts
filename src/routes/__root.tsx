...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Engineering Platform — Cloud, DevOps & Platform Engineering" },
      {
        name: "description",
        content:
          "A production-grade engineering platform showcasing cloud architecture, DevOps automation and AI-assisted delivery.",
      },
