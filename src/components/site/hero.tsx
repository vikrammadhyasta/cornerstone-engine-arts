...
const SOCIAL_LINKS = [
  ...
  {
    href: "https://www.linkedin.com/in/vikram-madhyasta",
    label: "LinkedIn",
    icon: Linkedin,
    external: true,
  },
      ...
      <div className="container-page relative z-10">
        <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-12">
          <div className="flex flex-col gap-6">
            <span
              style={{ "--boot-delay": "620ms" } as CSSProperties}
              className="boot-item inline-flex w-fit max-w-full items-center gap-2 rounded-full border border-border bg-surface/60 px-3 py-1 font-mono text-[0.625rem] tracking-[0.16em] text-muted-foreground uppercase backdrop-blur-sm sm:text-[0.6875rem] sm:tracking-[0.18em]"
            >
            ...
            <h1
              style={{ "--boot-delay": "760ms" } as CSSProperties}
              className="boot-item text-gradient-heading font-display text-[2rem] leading-[1.1] font-semibold text-balance sm:text-[2.5rem] lg:text-5xl xl:text-[3.25rem] xl:leading-[1.08]"
            >
            ...
            <p
              style={{ "--boot-delay": "880ms" } as CSSProperties}
              className="boot-item max-w-xl text-base leading-relaxed text-muted-foreground sm:text-lg"
            >
              Hi, I’m Vikram Madhyasta, a Cloud & DevOps Engineer pursuing a Master of Engineering
              in Cloud Computing. I’m focused on building reliable cloud systems, automating
              software delivery, and turning infrastructure into reproducible, maintainable
              engineering workflows.
            </p>

            <div
              style={{ "--boot-delay": "1000ms" } as CSSProperties}
              className="boot-item flex flex-col gap-2.5 sm:flex-row sm:flex-wrap sm:items-center sm:gap-3"
            >
              ...
              <Button
                ...
                variant="ghost"
                asChild
                className="h-11 w-full px-5 sm:h-12 sm:w-auto"
              >
            ...
            <div
              style={{ "--boot-delay": "1080ms" } as CSSProperties}
              className="boot-item flex items-center gap-1"
            >
