      ...
      <div className="container-page">
        <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-12">
          <div className="flex flex-col gap-6">
            <span style={{ "--boot-delay": "620ms" } as React.CSSProperties} className="boot-item inline-flex w-fit max-w-full items-center gap-2 rounded-full border border-border bg-surface/60 px-3 py-1 font-mono text-[0.625rem] tracking-[0.16em] text-muted-foreground uppercase backdrop-blur-sm sm:text-[0.6875rem] sm:tracking-[0.18em]">
            ...
            <h1 style={{ "--boot-delay": "760ms" } as React.CSSProperties} className="boot-item text-gradient-heading font-display text-[1.875rem] leading-[1.12] font-semibold text-balance sm:text-4xl xl:text-[2.9rem] xl:leading-[1.1]">
              Engineering cloud platforms with Kubernetes, Infrastructure as Code, and automation.
            </h1>

            <p style={{ "--boot-delay": "880ms" } as React.CSSProperties} className="boot-item max-w-xl text-base leading-relaxed text-muted-foreground sm:text-lg">
            ...
            <div style={{ "--boot-delay": "1000ms" } as React.CSSProperties} className="boot-item flex flex-col gap-2.5 sm:flex-row sm:flex-wrap sm:items-center sm:gap-3">
            ...
            <dl style={{ "--boot-delay": "1120ms" } as React.CSSProperties} className="boot-item mt-1 divide-y divide-border border-y border-border sm:mt-2 sm:grid sm:grid-cols-3 sm:gap-px sm:divide-y-0 sm:overflow-hidden sm:rounded-xl sm:border sm:bg-border">
              {FACTS.map((fact) => (
                <div
                  key={fact.label}
          ...
          <div style={{ "--boot-delay": "900ms" } as React.CSSProperties} className="boot-item order-last">
            <CloudOpsCenter />
          </div>
        </div>
      </div>
